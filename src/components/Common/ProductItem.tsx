...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group border border-gray-3 p-4 rounded-lg bg-[#F6F7FB] shadow-sm ">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] ">
        <Image
      ...
      <h3
        className="line-clamp-2 min-h-[38px] text-sm font-medium leading-snug text-dark ease-out duration-200 hover:text-blue mb-1 sm:min-h-0 sm:text-base sm:mb-1.5"
