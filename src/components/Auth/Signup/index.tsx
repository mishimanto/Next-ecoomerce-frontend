    ...
    <div className="max-w-[570px] w-full rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div>
              <form onSubmit={handleSubmit}>
                ...
                <PasswordInput
                  label={<>Password <span className="text-red">*</span></>}
                  name="password"
                  id="password"
                ...
                <PasswordInput
                  label={<>Re-type Password <span className="text-red">*</span></>}
            ...
            <div className="flex flex-col gap-4.5 mt-4.5">
              <button type="button" onClick={startGoogleLogin} className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-gray-1 p-3 ease-out duration-200 hover:bg-gray-2">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <Link
                href="/"
                className="flex justify-center font-medium text-dark-4 ease-out duration-200 hover:text-blue"
              >
                Back to home
              </Link>
            </div>
