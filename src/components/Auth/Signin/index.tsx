...
const Signin = () => {
  ...
  return (
    <div className="max-w-[570px] w-full rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            <Link href="/" className="mb-3 flex justify-center font-medium text-dark-4 ease-out duration-200 hover:text-blue">
                Back to home
            </Link>
            ...
            <div>
              <form onSubmit={handleSubmit}>
                {status && (
                  <div
                    className="mb-5 rounded-lg border border-red/20 bg-red/10 px-5 py-3 text-red"
                    role="alert"
                  >
                    {status}
                  </div>
