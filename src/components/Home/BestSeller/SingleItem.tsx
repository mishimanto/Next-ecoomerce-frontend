...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden border shadow-sm border-gray-3 rounded-lg bg-[#F6F7FB] min-h-[285px] sm:min-h-[335px] xl:min-h-[403px]">
        <div className="text-center px-3 pt-2.5 sm:px-4">
          <div className="flex items-center justify-center gap-1.5 sm:gap-2.5 mb-1.5 sm:mb-2">
          ...
          <span className="flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5 font-medium text-sm sm:text-base lg:text-lg">
        ...
        <div className="flex justify-center items-center px-3">
          <Image
            ...
            height={280}
            unoptimized
            className="max-h-[145px] w-auto sm:max-h-[190px] xl:max-h-[280px]"
          />
        </div>

        <div className="absolute right-0 top-1 flex translate-x-full flex-col gap-2 p-3 ease-linear duration-300 group-hover:translate-x-0 group-focus-within:translate-x-0 group-active:translate-x-0 lg:p-5.5">
          <button
            onClick={() => {
