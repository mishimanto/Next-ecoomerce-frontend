        ...
        <div className="shadow-list relative overflow-hidden flex items-center justify-center max-w-[270px] w-full sm:min-h-[270px] p-4">
          ...
          <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-3 bg-white/95 text-dark shadow-2 backdrop-blur-sm ease-out duration-200 hover:border-blue hover:bg-blue hover:text-white"
            >
              <svg
            ...
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center gap-2 rounded-full bg-blue text-white shadow-2 ease-out duration-200 hover:bg-blue-dark lg:w-auto lg:px-4"
            >
